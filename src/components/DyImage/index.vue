...
<template>
  <div class="vab-image__outter">
    <el-image :src="bigSrc" fit="cover" style="width: 100%;height: 100%" @click="clickBig">
    </el-image>
    <el-image :src="smallSrc" class="vab-image__outter__small" fit="cover" @click="clickSmall"></el-image>
